...
public class BlogRecyclerAdapter extends RecyclerView.Adapter<BlogRecyclerAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
       ...
       String titleText = blog_list.get(position).getTitle();
        holder.setPostTitleText(titleText);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setPostTitleText(String postTitleText){
            ...
            postTitleView = mView.findViewById(R.id.blogTitle);
            postTitleView.setText(postTitleText);
